...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TAB,         KC_Q,         KC_W,   KC_F,   KC_P,   KC_B,   TG(1),
    LT(KC_FN1,KC_ESC),  KC_A,         KC_R,   KC_S,   KC_T,   KC_G,
 ...
 *                                 |      |      |      |       |      |      |      |
 *                                 `--------------------'       `--------------------'
 * NOTE: add printscreen, insert, caps lock, to left hand thumb keys. Put -_ under the 1 key on the right hand
 */
// SYMBOLS
[SYMB] = KEYMAP(
       // left hand
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |BOOTLOAD|
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |MsWhUp| MsUp |MsWhDn|      |      |           |      |      |VolUp |VolDn | Mute |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 ...
 *                                 |      |      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 * Change Left and Right keys for upper left/right keys to be []{}?
 */
// If it accepts an argument (i.e, is a function), it doesn't need KC_.
// Otherwise, it needs KC_*
[QWERTY] = KEYMAP(  // layer 3 : default
        // left hand
        KC_EQL,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_LEFT,
        ...
        // right hand
             ...
             MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                  KC_DOWN,KC_UP,  KC_LBRC,KC_RBRC,          KC_TRNS,
             KC_LALT, CTL_T(KC_ESC),
             KC_PGUP,
             KC_PGDN, KC_ENT, KC_BSPC
    ),
...
const uint16_t PROGMEM fn_actions[] = {
	...
	[3] = ACTION_LAYER_TAP_TOGGLE(QWERTY)
};
